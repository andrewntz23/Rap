...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <div id="meta"><root><h4 id="dropping">Dropping:</h4>
                    <p>This attribute is used when a sound is dropped from a word. For
                    ...
                    <p>This attribute is used when the wrong tense is used in a phrase. For
                    ...
                    <p>This attribute is used when a word is deleted from a sentence. It is
                    ...
                    <p>This attribute is used when a phrase uses tense/aspect in a manner
                    ...
                    <p>This attribute is used when there is a double negative or a negative
                    ...
                    <p>This attribute is used when a word is contracted that is abnormal to
                    ...
                    <h4 id="Alcohol">Alcohol</h4><p> References to:
                    ...
                    </p><h4 id="Guns">Guns</h4><p> References to guns, both direct and
                        indirect. Example: <code>&lt;guns&gt;the heater&lt;/guns&gt;</code>
                    </p><h4 id="Haters">Haters</h4><p> This tag denotes those who do not
                        ...
                        fortune. Example: <code>&lt;haters&gt;Closed-minded
                            men&lt;/haters&gt;</code>
                    </p><h4 id="HipHop">Hip-Hop</h4><p> The hip hop tag always refers to a
                        ...
                        <code>&lt;hiphop ref="Jay-Z"&gt;I couldn't see it coming down my
                            eye&lt;/hiphop&gt;</code><br /><code>&lt;hiphop
                                ref="Jay-Z"&gt;So I hat to make the song
                                cry&lt;/hiphop&gt;</code>
                    </p><h4 id="History">History</h4><p> This tag denotes a reference to a
                        historical event or figure (including figures in ancient mythology).
                        Example: <code>&lt;history&gt;Underground
                            Railroad&lt;/history&gt;</code>
                    </p><h4 id="Money">Money</h4><p> This tag is used to mark any references
                        ...
                        Example: <code>&lt;money qual="possession"&gt;pockets
                            healthy&lt;/money&gt;</code>
                    </p><h4 id="Oldschool">Oldschool</h4><p> This tag marks a reference or
                    ...
                    </p><h4 id="Popculture">Pop Culture</h4><p> The popculture tag denotes a
                    ...
                    </p><h4 id="Power">Power</h4><p> The power tag marks figures and ideas
                    ...
                    </p><h4 id="Religion">Religion</h4><p> The religion tag here is
                        ...
                        <code>&lt;religion&gt;on some third eye
                            shit&lt;/religion&gt;</code>
                    </p><h4 id="Sex">Sex</h4><p> This tag marks references to a sexual act,
                        ...
                        ancient Greek festival celebrating Bacchus, god of wine. </p><h4
                            id="Sports">Sports</h4><p> This tag marks all sports references. The
                            ...
                            </p><h4 id="Struggle">Struggle</h4><p> The purpose of this tag is to
                                ...
                                <code>&lt;struggle&gt;And I'm from the blocks where they
                                    sell&lt;/struggle&gt;</code>
                            </p><h4 id="Success">Success</h4><p> This tag indicates either Joey's
                                ...
                                his mother. Example: <code>&lt;success qual="pursuit"&gt;Won't stop
                                    ...
                                    Rover&lt;/success&gt;</code>
                            </p><h4 id="Violence">Violence</h4><p> The violence tag is used to
                                ...
                                <code>&lt;violence&gt;Rip your lips off your
                                    mouth&lt;/violence&gt;</code>
                            </p><h4 id="Weed">Weed</h4><p> This tag is used to mark any instance
                                where Joey discusses marijuana-related activities. Example:
                                <code>&lt;weed&gt;exotic piff&lt;/weed&gt;</code>
                            </p><h4 id="Women">Women</h4><p> This tag marks references to women, and
                                ...
                                positive: Example: <code>&lt;women
                                    qual="pos"&gt;Mama&lt;/women&gt;</code></p>
                    
                    <h4 id="pointerSystem">Pointer System</h4>
                    <p>Given the intricate nature of Joey Bada$$'s use of various poetic
                        devices, the poetic analysis of this project first needed to develop a
                        markup system that would adequately account for the complex nature of
                        poetry within Joey's lyrical corpus. We settled on giving each poetic
                        element, within its corresponding poetic device group, a @num attribute,
                        the value of which is its position within the group. The value of each
                        attribute is numerical, in order of all tags with which the poetic bond
                        exists. For example, within a group consisting of five tags, if tag 1
                        and tag 3 rhyme, tag 1 will have a @rhyme="3" attribute and tag 3 will
                        have a @rhyme="1" attribute. If tags 1 and 3 also rhyme with tags 6 and
                        9, tag 1 would have a @rhyme="3 6 9" attribute, tag 3 would have a
                        @rhyme="1 6 9" attribute, and so on. Sample markup from the project has
                        been provided at the bottom of this page.</p>
                    <h4 id="alliteration">Alliteration:</h4>
                    <p>A poetic device in which there is a repetition of the first consonant in
                    ...
                    <p>A poetic device in which one word becomes more phonologically similar to
                        ...
                        seem to rhyme.<br /> e.g. And I know the landlord fed up with <em>our
                            lies</em><br /> So we pray to the Gods, the Jahs, and the
                        <em>Allahs</em><br /> To keep us safe and watch <em>our
                            lives</em>.<br /></p>
                    <h4 id="assonance">Assonance:</h4>
                    <p>A poetic device in which words near each other have a repetition of a
                        vowel in nonrhyming stressed syllables.<br /> e.g. Tend this
                        <em>racket</em> while I'm <em>cracking</em> a Serena.</p>
                    <h4 id="consonance">Consonance:</h4>
                    <p>A poetic device in which words near each other have a repetition of a
                        ...
                        <em>out</em></p>
                    <h4 id="rhyme">Rhyme:</h4>
                    <p>A poetic device in which there is a correspondence of sound between words
                        or the endings of words.<br /> e.g. I know she always think of little
                        me, but now I got big <em>literally</em><br /> Worldwide and
                        <em>physically</em><br /> I'm saying I used to take walks around
                        <em>Little Italy</em><br /> Now I roam 'round <em>Sicily</em><br />
                        And I'm plotting on a <em>milli</em><br /></p>
                    <h4 id="slantRhyme">Slant Rhyme:</h4>
                    <p>A poetic device in which a rhyme is formed by words with similar but not
                        ...
                        than speech <em>impediments</em><br /> Brooklyn's the
                        <em>residence</em>, the best and it's <em>evident</em><br /></p>
                    <h4 id="examplePoeticMarkup">Example Poetic Markup:</h4>
                </root></div>
